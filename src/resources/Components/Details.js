  ...
  return (
           <Box 
             ...
             <Grid container rowSpacing={1} columnSpacing={3}>
               ...
               <Grid item xs={9} md={4} sx={{marginLeft:'25px'}}>
                 <Item sx={{height:{md:350, xs:'auto'}}}>
              ...
              <Typography variant='inherit' sx={{marginTop:3,color:'gray',marginLeft:2}} gutterBottom >Keywords</Typography>
                 <Stack direction="row"  rowspacing={1} display={'flex'} flexWrap={xs='wrap'}>
                   {keywords.map((word,i)=> <Chip key={i} label={word} />)}
